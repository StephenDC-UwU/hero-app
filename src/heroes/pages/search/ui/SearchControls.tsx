...
const SearchControls = () => {
    ...
    const handleClickDown = (event: React.KeyboardEvent<HTMLInputElement>) => {
        if (event.key === 'Enter') {
        ...
        <>
            <div className="flex flex-col lg:flex-row gap-4 mb-8">
                ...
                <div className="relative flex-1">
                    ...
                    <Input
                        ref={inputRef}
                        placeholder="Search heroes, villains, powers, teams..." className="pl-12 h-12 text-lg"
                ...
                <div className="flex gap-2">
                    <Button
                        ...
                        onClick={() => {
                            setQueryParams(
                                'active-accordion',
                                activeAccordion === 'advance-filters' ? '' : 'advance-filters'
                            )
                        }}
                    >
            ...
            < Accordion defaultValue={["item-1"]} value={activeAccordion} >
